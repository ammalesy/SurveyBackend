...
--
-- Host: localhost
-- Generation Time: Sep 21, 2015 at 12:38 PM
...
INSERT INTO `tb_permission` (`pm_id`, `pm_name`, `question_mgnt`, `survey_mgnt`, `survey_result_mgnt`, `admin_mgnt`) VALUES
(1, 'superadmin', 'rw', 'rw', 'rw', 'rw'),
(2, 'manager', 'rw', 'rw', 'rw', 'n'),
(3, 'user', 'r', 'rw', 'rw', 'n');
...
INSERT INTO `tb_project` (`pj_id`, `pj_name`, `pj_description`, `pj_db_ref`, `pj_image`) VALUES
(1, 'The real condo', 'The real condo survey. if you are manager you can manages the role user and add some question.', 'SurveyNew2', 'banner_1.png');
...
--
ALTER TABLE `tb_project`
MODIFY `pj_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
