...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="surveyForm" role="form" method="post" action="<?php echo APP_PATH.'index.php/'; ?>SurveyManagement/submit/null/added">
                 ...
                 <script>
                            ...
                            function increase(){
                               ...
                               var html = 
                                ...
                                '            <input disabled name="question_group[]" id="question_group" class="form-control" placeholder="Please select a question.">'+
                                '        </div>  '+
                                '    </div>'+
                                '</div>'+
            ...
            <tr>
                ...
                <td class="dt-body-right">
                        <button type="button" id="view_button" data-aq-description="<?php echo $question->aq_description; ?>" data-aq-id="<?php echo $question->aq_id; ?>" data-toggle="modal" data-target="#detail_question_modal" class="btn btn-sm btn-primary">
                            ...
                            <button type="button" data-aq-id="<?php echo $question->aq_id; ?>" class="btn btn-sm btn-success">
                                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                            </button>
                        </td>
                    </tr> 
...
<script>
    ...
    $("button#view_button").click(function(){
        ...
        var obj_answer = search_answer_in_cache(aq_id);
        if (obj_answer != null) {
        ...
        $.get("<?php echo APP_PATH.'index.php/'; ?>api/QuestionManagement/answers/"+aq_id, function(data, status){
           var list_ans_html = '';
